    ...
    evidence: [
      {
        ...
        delta_log_odds: 0.48,
        date: '2025-11-14',
        summary: 'Novel architecture demonstrates cross-domain transfer learning surpassing prior benchmarks by 340%.',
      },
      {
        id: 'ev-agi-2',
        ...
        delta_log_odds: 0.34,
        date: '2026-01-22',
        summary: 'GPT-6 internal evaluation shows emergent reasoning on novel physics problems.',
      },
      {
        id: 'ev-agi-3',
        ...
        delta_log_odds: -0.28,
        date: '2025-09-05',
        summary: 'Expert consensus survey: 72% of AI researchers consider 2035 AGI timeline "unlikely" without fundamental breakthroughs.',
      },
      {
        id: 'ev-agi-4',
        source: 'DeepMind',
        ...
        delta_log_odds: 0.35,
        date: '2026-02-10',
        summary: 'Gemini Ultra 2 achieves superhuman performance on ARC-AGI-2 challenge, solving 91% of tasks.',
      },
      {
        id: 'ev-agi-5',
        source: 'Epoch AI',
        ...
        delta_log_odds: 0.12,
        date: '2025-12-03',
        summary: 'Compute scaling analysis projects sufficient hardware availability for AGI-class systems by 2032.',
      },
      {
        id: 'ev-agi-6',
        source: 'MIRI Technical Report',
        type: 'expert_analysis',
        direction: 'ambiguous',
        credibility: 0.80,
        recency: 0.85,
        ...
        delta_log_odds: 0.03,
        date: '2025-10-20',
        summary: 'Alignment challenges may delay deployment even if capability milestones are met. Impact on timeline unclear.',
      },
    ],
    ...
    evidence: [
      {
        ...
        delta_log_odds: 0.62,
        date: '2025-08-15',
        summary: 'NIF achieves sustained ignition for 8 seconds with Q>5, demonstrating commercial viability pathway.',
      },
      {
        id: 'ev-fus-2',
        ...
        delta_log_odds: 0.36,
        date: '2026-01-08',
        summary: 'SPARC tokamak exceeds design parameters, HTS magnets performing above spec at 20T.',
      },
      {
        id: 'ev-fus-3',
        source: 'DOE Report',
        ...
        delta_log_odds: 0.05,
        date: '2025-06-20',
        summary: 'DOE fusion roadmap identifies 12 remaining engineering challenges; timeline contingent on materials breakthroughs.',
      },
      {
        id: 'ev-fus-4',
        source: 'ITER Update',
        ...
        delta_log_odds: -0.37,
        date: '2025-04-12',
        summary: 'ITER first plasma delayed to 2030; cost overruns signal persistent engineering scale-up challenges.',
      },
    ],
    ...
    evidence: [
      {
        ...
        delta_log_odds: 0.37,
        date: '2026-02-20',
        summary: 'Phase 2 clinical trial data shows 94% success rate in motor control restoration with N1 implant.',
      },
      {
        id: 'ev-bci-2',
        source: 'Science',
        ...
        delta_log_odds: 0.66,
        date: '2025-10-05',
        summary: 'Non-invasive ultrasound BCI achieves 95% typing accuracy at 60 WPM in healthy subjects.',
      },
      {
        id: 'ev-bci-3',
        source: 'The Lancet',
        ...
        delta_log_odds: -0.51,
        date: '2025-07-18',
        summary: 'Long-term implant study shows signal degradation of 40% over 18 months due to glial scarring.',
      },
    ],
    ...
    evidence: [
      {
        ...
        delta_log_odds: 0.47,
        date: '2026-01-15',
        summary: 'Willow 2 processor demonstrates 1,000 logical qubits with error rates below threshold.',
      },
      {
        id: 'ev-q-2',
        ...
        delta_log_odds: 0.43,
        date: '2025-09-28',
        summary: 'Novel topological qubit design shows 100x improvement in coherence time.',
      },
      {
        id: 'ev-q-3',
        ...
        delta_log_odds: -0.16,
        date: '2025-11-10',
        summary: 'Industry analysts note commercial quantum advantage remains elusive for practical applications.',
      },
    ],
    ...
    evidence: [
      {
        ...
        delta_log_odds: 0.86,
        date: '2026-02-01',
        summary: 'Starlink V3 satellites achieve 1Gbps to consumer terminals; 6,200 satellites operational.',
      },
      {
        id: 'ev-sat-2',
        source: 'ITU Report',
        ...
        delta_log_odds: 0.46,
        date: '2025-05-22',
        summary: 'ITU designates LEO spectrum allocation supporting 3 competing constellation operators.',
      },
    ],
    ...
    evidence: [
      {
        ...
        delta_log_odds: 0.18,
        date: '2025-03-12',
        summary: 'DNA origami assembler demonstrates programmable molecular-scale construction with 85% yield.',
      },
    ],
...
// Trajectory data for Traces view (composite capability index per domain, 1900-2060)
