  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="font-display text-2xl font-bold text-foreground">Triage Queue</h1>
          <p className="text-sm text-muted-foreground mt-1">Milestones ranked by urgency, proximity, and magnitude</p>
        </div>
